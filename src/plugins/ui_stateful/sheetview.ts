...
export class SheetViewPlugin extends UIPlugin {
   ...
   */
  /**
   * Cập nhật getColIndex:
   * Khi người dùng click chuột, tọa độ x nhận được là pixel trên màn hình (đã bị zoom).
   * Ta cần chia cho zoomRatio để lấy tọa độ thực tế trong model trước khi tìm cột.
   */
   ...
   */
  /**
   * Cập nhật getRowIndex: Tương tự như cột.
   */

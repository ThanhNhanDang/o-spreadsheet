...
export interface SetZoomCommand extends SheetDependentCommand {
  type: "SET_ZOOM";
  zoom: number; // percentage (50-200)
}

export interface ResetZoomCommand extends SheetDependentCommand {
  type: "RESET_ZOOM";
}

// 2. Thêm interface cho Local Commands (sau dòng ~1400, trước export type LocalCommand)
...
export interface SetZoomLevelCommand {
  type: "SET_ZOOM_LEVEL";
  level: number;
}
